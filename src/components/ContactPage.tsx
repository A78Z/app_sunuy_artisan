...
import { Mail, Phone, MapPin, Send, User, MessageSquare, ArrowLeft } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-primary-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          <Link 
            to="/" 
            className="inline-flex items-center text-primary-600 hover:text-primary-700 transition-colors duration-300 group"
          >
